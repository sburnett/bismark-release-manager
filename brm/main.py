...
def create_groups_subcommands(subparsers):
    parser_list_group = subparsers.add_parser('list', help='list nodes in a groups')
    parser_list_group.add_argument('name', type=str, nargs='?', action='store', help='name of the group to list')
    parser_list_group.set_defaults(handler=commands.list_group)

    parser_new_group = subparsers.add_parser('new', help='create a new group of nodes')
    ...
    parser_delete_group = subparsers.add_parser('delete', help='delete a group of nodes')
    ...
    parser_add_to_group = subparsers.add_parser('add-nodes', help='add nodes to a group')
    ...
    parser_remove_from_group = subparsers.add_parser('remove-nodes', help='remove nodes from a group')
...
def create_experiments_subcommands(subparsers):
    parser_new_experiment = subparsers.add_parser('new', help='create a new experiment')
    ...
    parser_add_to_experiment = subparsers.add_parser('add-package', help='add a package to an experiment')
    ...
    parser_remove_from_experiment = subparsers.add_parser('remove-package', help='remove a package from an experiment')
    ...
    parser_list_experiment = subparsers.add_parser('list', help='list experiment details')
    parser_list_experiment.add_argument('experiment', type=str, nargs='?', action='store', help='list details for this experiment')
    parser_list_experiment.set_defaults(handler=commands.list_experiment)

    parser_list_experiment_packages = subparsers.add_parser('list-packages', help='list packages for an experiment')
    ...
    parser_require_experiment = subparsers.add_parser('require', help='require a group of routers to install an experiment')
    ...
    parser_unrequire_experiment = subparsers.add_parser('unrequire', help='stop requiring a group of routers to install an experiment')
...
def create_packages_subcommands(subparsers):
    parser_add_packages = subparsers.add_parser('import', help='import ipk files for a release')
    parser_add_packages.add_argument('release', type=str, action='store', help='import packages for this release (e.g., quirm)')
    parser_add_packages.add_argument('ipk', nargs='+', type=str, action='store', help='ipkg files to import')
    parser_add_packages.set_defaults(handler=commands.add_packages)

    parser_list_packages = subparsers.add_parser('list', help='list available packages')
    ...
    parser_list_builtin_packages = subparsers.add_parser('list-builtin', help='list builtin packages for a release')
    ...
    parser_list_extra_packages = subparsers.add_parser('list-extra', help='list "extra" packages for a release')
    ...
    parser_remove_extra_package = subparsers.add_parser('remove-from-extra', help='remove packages from the "extra" set')
    ...
    parser_add_extra_package = subparsers.add_parser('add-to-extra', help='add packages to the "extra" set')
...
def create_releases_subcommands(subparsers):
    parser_list_releases = subparsers.add_parser('list', help='list all releases')
    ...
    parser_new_release = subparsers.add_parser('new', help='create a new release')
...
def main():
    ...
    parser_groups = subparsers.add_parser('groups', help='Manage groups of nodes')
    groups_subparsers = parser_groups.add_subparsers(title='group subcommands')
    create_groups_subcommands(groups_subparsers)

    parser_experiments = subparsers.add_parser('experiments', help='Manage experiments')
    experiments_subparsers = parser_experiments.add_subparsers(title='experiments subcommands')
    create_experiments_subcommands(experiments_subparsers)

    parser_packages = subparsers.add_parser('packages', help='Manage packages')
    packages_subparsers = parser_packages.add_subparsers(title='packages subcommands')
    create_packages_subcommands(packages_subparsers)

    parser_releases = subparsers.add_parser('releases', help='Manage releases')
    releases_subparsers = parser_releases.add_subparsers(title='releases subcommands')
